...
async function firebase_init() {
    ...
    // switch to file cloud;
    // var db = admin.database();
    var db = admin.firestore();
    return db;
    // var ref = db.ref('/indicators');
    // await ref.parent.set(null);
    // ref.set(push_to_cloud_data, function (error) {
    //     if (error) {
...
async function firebase_save(db: any) {
    ...
    try {
        // var indicators_ref = db.ref('/indicators');
        // await indicators_ref.set(null);

        var indicatorsRef = db.collection('stock').doc('indicators');
        ...
        indicatorsRef.set(push_to_cloud_data_indicators, function (error: any) {
            if (error) {
                console.log('Indicators Data could not be saved.' + error);
            } else {
                console.log('Indicators Data saved successfully.');
            }
        });

        // indicators_ref.set(push_to_cloud_data_indicators, function (error: any) {
        //     if (error) {
        //         console.log('Indicators Data could not be saved.' + error);
        //     } else {
        //         console.log('Indicators Data saved successfully.');
        ...
        // var candlesStick_ref = db.ref('/candlesStick');
        // await candlesStick_ref.set(null);

        var candlesStickRef = db.collection('stock').doc('candlesStick');
        ...
        candlesStickRef.set(push_to_cloud_data_candlesStick, function (error: any) {
            if (error) {
                console.log('Indicators Data could not be saved.' + error);
            } else {
                console.log('Indicators Data saved successfully.');
        ...
        // candlesStick_ref.set(push_to_cloud_data_candlesStick, function (error: any) {
        //     if (error) {
        //         console.log('candlesStick Data could not be saved.' + error);
        //     } else {
        //         console.log('candlesStick Data saved successfully.');
        //     }
        // });

        // var pattern_ref = db.ref('/pattern');
        // await pattern_ref.set(null);
        var patternRef = db.collection('stock').doc('pattern');
        ...
        patternRef.set(push_to_cloud_data_pattern, function (error: any) {
            if (error) {
                console.log('Indicators Data could not be saved.' + error);
            } else {
                console.log('Indicators Data saved successfully.');
        ...
        // pattern_ref.set(push_to_cloud_data_pattern, function (error: any) {
        //     if (error) {
        //         console.log('pattern Data could not be saved.' + error);
        //     } else {
        //         console.log('pattern Data saved successfully.');
        //     }
        // });


        // var regression_ref = db.ref('/regression');
        // await regression_ref.set(null);
        var regressionRef = db.collection('stock').doc('regression');
        ...
        regressionRef.set(push_to_cloud_data_regression, function (error: any) {
            if (error) {
                console.log('Indicators Data could not be saved.' + error);
            } else {
                console.log('Indicators Data saved successfully.');
        ...
        // regression_ref.set(push_to_cloud_data_regression, function (error: any) {
        //     if (error) {
        //         console.log('regression Data could not be saved.' + error);
        //     } else {
        //         console.log('regression Data saved successfully.');
        //     }
        // });
